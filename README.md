...
eden bir makine öğrenmesi modeli geliştirmektir.  
Bu projede Kaggle üzerinde paylaşılan Smart Home Energy Consumption and Weather veri seti kullanılmıştır.
